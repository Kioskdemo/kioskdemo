        ...
        <div className="flex justify-center flex-col text-[40px]">
          <form action="" className="text-[30px] p-8">
            <div className="flex justify-center gap-5">
              ...
              <div className="flex flex-col basis-1/2">
                <label htmlFor="">Property Identification No.</label>
                <input
                  size={5}
                  name=""
                  placeholder="Type here"
            ...
            <div className="flex justify-center gap-5">
              <div className="flex flex-col basis-1/2">
                <label htmlFor="">OCT/TCT/CLOA No.</label>
                <input
                  size={5}
                  name=""
                  placeholder="Type here"
            ...
            <div className="flex justify-center gap-5">
              <div className="flex flex-col basis-1/2">
                <label htmlFor="">Municipal Assessor</label>
                <input
                  size={5}
                  name=""
                  placeholder="Type here"
              ...
              <div className="flex flex-col basis-1/2">
                <label htmlFor="">Provincial Assessor</label>
                <input
                  size={5}
                  name=""
                  placeholder="Type here"
